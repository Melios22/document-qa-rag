...
from ..rag_builder.model_loader import load_bge_m3_model, load_reranker_model
...
class VietnameseRAG:
    ...
    class DocumentRetriever:
        ...
        def retrieve_and_rerank(self, query: str) -> Tuple[List[Document], List[float]]:
            ...
            try:
                ...
                documents, rerank_scores = hybrid_search(
                    query=query,
                    client=self.parent.client,
                    collection_name=self.parent.collection_name,
                    embedding_model=self.parent.embedding_model,
                    reranker_model=self.parent.reranker_model,
                    k=self.parent.k,
                    rerank_top_k=self.parent.rerank_top_k,
        ...
        def search_only(
            ...
            try:
                documents, scores = hybrid_search(
                    query=query,
                    client=self.parent.client,
                    collection_name=self.parent.collection_name,
                    embedding_model=self.parent.embedding_model,
    ...
    def __init__(
        ...
        **llm_kwargs,
        ...
        # Load models
        self.embedding_model = embedding_model or load_bge_m3_model()
        self.reranker_model = reranker_model or load_reranker_model()
        ...
        self.retriever = self.DocumentRetriever(self)
        self.generator = self.AnswerGenerator(self)
...
# Alias for the main class (can be imported as either name)
UnifiedVietnameseRAG = VietnameseRAG
